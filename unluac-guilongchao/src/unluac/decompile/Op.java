...
public enum Op {
  ...
  GETFIELD("getfield", OpV.LUA5455 | OpV.LUA51, OperandFormat.AR, OperandFormat.BR, OperandFormat.CKS),
  ...
  // Special GuiLongchao Lua 5.1 Opcodes
  GETTABLE2("gettable2", OpV.LUA51, OperandFormat.AR, OperandFormat.BRK, OperandFormat.CRK),
  JMP_SHORT("jmpshort", OpV.LUA51, OperandFormat.CI),
  JMP_FAR("jmpfar", OpV.LUA51, OperandFormat.BI);
  ...
  public int jumpField(int codepoint, CodeExtract ex) {
    switch(this) {
      ...
      case JMP_SHORT:
        return ex.C.extract(codepoint);
      case JMP_FAR:
          return ex.B.extract(codepoint);
      default:
  ...
  public int target(int codepoint, CodeExtract ex) {
    switch(this) {
      ...
      case GETGLOBAL:
      case GETTABLE: case GETTABLE54: case GETI: case GETFIELD: case GETTABLE2:
      ...
      case JMP: case JMP52: case JMP54: case JMP_SHORT: case JMP_FAR:
